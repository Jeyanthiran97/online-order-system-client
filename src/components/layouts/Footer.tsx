...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-footer-bg-start via-footer-bg-mid to-footer-bg-end text-footer-text">
      <div className={`${designSystem.container.maxWidth} mx-auto ${designSystem.container.padding} py-10`}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <p className={`text-footer-text-muted ${designSystem.typography.small} leading-relaxed`}>
              Your trusted marketplace for quality products. Shop with confidence from verified sellers.
            </p>
            <div className="flex gap-3">
              <a 
                href="#" 
                className={`p-2 rounded-full bg-footer-icon-bg hover:bg-primary transition-colors ${designSystem.button.base} ${designSystem.button.hover}`}
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-footer-text-muted text-sm">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-footer-border pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-footer-text-subtle text-sm">
